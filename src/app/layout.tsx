    ...
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable}`}>
        ...
        <div style={{minHeight: '100vh', display: 'flex', flexDirection: 'column'}}>
          {children}
          <footer style={{background: '#17181c', color: '#ededed', padding: '2rem 0 1rem 0', textAlign: 'center', marginTop: 'auto'}}>
